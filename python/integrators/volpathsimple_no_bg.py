...
class VolpathSimpleNoBgIntegrator(mi.ad.integrators.common.RBIntegrator):
...
mi.register_integrator("volpathsimple_no_bg", lambda props: VolpathSimpleNoBgIntegrator(props))
